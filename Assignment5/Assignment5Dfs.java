...
public class Assignment5Dfs {

	public static void main(String[] args) {
		
		System.out.println("Performing DFS Topological Sort on Graph1");
		DfsQ1();
		System.out.println("-------------------------------------------------------------------------");
		System.out.println();
		System.out.println("Performing DFS Topological Sort on Graph2");
		DfsQ2();
		System.out.println("-------------------------------------------------------------------------");
	...
	public static void DfsQ1() {
		...
		List<Integer> topologicallyOrderedList = TopologicalSortDfs.performTopologicalSortDfs(graph, numberOfVertices);
		
		if (topologicallyOrderedList != null) {
			System.out.println("========== DFS Topologically Ordered Graph ==========");
